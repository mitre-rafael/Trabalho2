...
public class ServletCatalogacao extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        boolean resultadoInsercao;
        ...
        resultadoInsercao= (new ReferenciasBibliograficas()).incluirReferencia(dto); 
    
        if (resultadoInsercao){
        jsonResposta = Json.createObjectBuilder()
                    .add("resultado","Dado adicionado com sucesso")
                    .build();
        }
        else{
        jsonResposta = Json.createObjectBuilder()
