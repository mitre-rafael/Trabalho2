 ...
 * @author rafael
 */
public class ServletEdicao extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        
        boolean resultadoEdicao;
        ...
        resultadoEdicao= (new ReferenciasBibliograficas()).editarReferencia(dto); 
        if (resultadoEdicao){
        jsonResposta = Json.createObjectBuilder()
                    .add("resultado","Dado editado com sucesso")
                    .build();
        }
        else{
        jsonResposta = Json.createObjectBuilder()
